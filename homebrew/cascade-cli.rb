...
class CascadeCli < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/JAManfredi/cascade-cli/releases/download/v1.0.7/ca-macos-arm64.tar.gz"
    sha256 "PLACEHOLDER_ARM64_SHA"
  else
    url "https://github.com/JAManfredi/cascade-cli/releases/download/v1.0.7/ca-macos-x64.tar.gz"
