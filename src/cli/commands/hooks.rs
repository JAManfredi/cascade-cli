    ...
    fn generate_pre_commit_hook(&self, cascade_cli: &str) -> String {
        ...
        #[cfg(not(windows))]
        {
            ...
            vec![
                ...
                "   else".to_string(),
                "       # Non-interactive (e.g., git commit -m) - default to New".to_string(),
                r#"       echo "💡 Tip: Running 'git commit' without -m lets you choose between Amend/New""#.to_string(),
                r#"       echo "Proceeding with new entry...""#.to_string(),
                "       choice=N".to_string(),
                "   fi".to_string(),
                "   ".to_string(),
                "   ".to_string(),
