    ...
    fn generate_pre_commit_hook(&self, cascade_cli: &str) -> String {
        ...
        #[cfg(not(windows))]
        {
            ...
            vec![
                ...
                r#"       echo """#.to_string(),
                r#"       echo "❌ Cannot use 'git commit -m' while in edit mode!""#.to_string(),
                r#"       echo """#.to_string(),
                ...
                r#"        echo """#.to_string(),
                r#"        echo "⚠️  WARNING: You're on a stack entry branch!""#.to_string(),
                r#"        echo """#.to_string(),
                r#"        echo "You're on branch: $CURRENT_BRANCH""#.to_string(),
                r#"        echo """#.to_string(),
                r#"        echo "❌ Cannot commit directly to entry branches!""#.to_string(),
                r#"        echo """#.to_string(),
                r#"        echo "Did you mean to:""#.to_string(),
                format!("        echo \"  • {} entry checkout <N>  (proper edit mode)\"", cascade_cli),
